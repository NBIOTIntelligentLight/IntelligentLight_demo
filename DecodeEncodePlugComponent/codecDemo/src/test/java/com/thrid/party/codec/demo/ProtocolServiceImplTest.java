...
import com.ProtocolAdapterImpl;
...
public class ProtocolServiceImplTest {
    ...
    private static ObjectNode initCloudReqObjectNode() {
        ...
        cloudReqObjectNode.put("cmd", "SET_POWER_MODE");
     ...
     * {
    "command": {
         "method":"SET_POWER_MODE",
         "serviceId":"Configuration",
         "paras": {"status":"01","timeout":"100"}
    }
}
